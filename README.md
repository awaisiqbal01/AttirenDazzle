...
![amazona](/frontend/images/Attire&Dazzle.jpg)
...
- 👉 Heroku : [https://Attire&Dazzle.herokuapp.com](https://Attire&Dazzle.herokuapp.com)
- 👉 AWS : [https://Attire&Dazzle.webacademy.pro](https://Attire&Dazzle.webacademy.pro)
...
```
MONGODB_URL=mongodb://localhost/Attire&Dazzle
...
1. Create Folder Structure
   1. create root folder as Attire&Dazzle
   2. add frontend and backend folder
   3. create src folder in frontend
   4. create index.html with heading Attire&Dazzle in src
...
6. Create Node.JS Server
   1. run npm init in root Attire&Dazzle folder
...
44. Publish heroku
    ...
    4. heroku login
    5. heroku apps:create <yourname>Attire&Dazzle
